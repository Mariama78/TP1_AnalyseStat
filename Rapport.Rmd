...
ggplot(data.frame(Rentabilité = rentability_categories_filtered), aes(x = Rentabilité)) +
  ...
  theme_minimal()
```
Ce graphique est simple à comprendre : on voit que les films non rentables (<1) sont les plus nombreux, ce qui signifie que beaucoup de films ne réussissent pas à générer des bénéfices par rapport à leur budget.
